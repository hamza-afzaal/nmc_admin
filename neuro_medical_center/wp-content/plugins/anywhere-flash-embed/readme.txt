...
Simpley upload to the plugin folder and click on activate link. Once done you can put the shortcode anywhere in the editor.

**Can I edit the codes?**

This is a simple  plugin with only few page codes. You can easily edit the codes according to your requirement.
